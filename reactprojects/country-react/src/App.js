...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <Header title="World Counrty List" subTitle="Total number of counries " searchFrist="Starting word" searchSecond="Search with any word" />
        <Body name = {this.state.countries} />
      </div>
    );
  }
}
